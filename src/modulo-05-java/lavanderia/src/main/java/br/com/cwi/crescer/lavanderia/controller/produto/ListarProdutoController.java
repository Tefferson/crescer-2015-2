...
public class ListarProdutoController extends AbstractProdutoController {
	...
	public ModelAndView listarComFiltro(@RequestParam("idServico") Long idServico, @RequestParam("idMaterial") Long idMaterial) {

		return new ModelAndView("produto/lista", "produtos", produtoService.listarProdutosPorMaterialEServico(idMaterial, idServico));
	}
