...
public class ElfoTest
{
    ...
    public void elfoNasceApenasComNome(){
        ...
        assertEquals(null, elfo2.getNome());
        assertNull(elfo2.getNome());
        assertEquals(42, elfo2.getFlechas());
        assertFalse(42 != elfo2.getFlechas());
        assertNotNull(elfo2.getFlechas());
        assertEquals(0, elfo2.getExperiencia());
        assertFalse(0 != elfo2.getExperiencia());

    }

    @Test
    public void elfoAtiraFlechaNoDwarfPerdeFlechasEGanhaExperiencia(){
        int flechas = 34434543;
        String nome = "elfo", nome2 = "!@#$%¨&*()_+";
        Elfo elfo = new Elfo(nome, flechas);       
        Elfo elfo2 = new Elfo(nome2);             
        Elfo elfo3 = new Elfo(null);        
        Dwarf dwarf = new Dwarf(), dwarf2 = new Dwarf();
        ...
        assertFalse(41 != elfo2.getFlechas());
        assertEquals(1, elfo2.getExperiencia());
        assertFalse(1 != elfo2.getExperiencia());

        elfo3.atirarFlecha(dwarf2);

        assertEquals(41, elfo3.getFlechas());
        assertFalse(41 != elfo3.getFlechas());
        assertEquals(1, elfo3.getExperiencia());
        assertFalse(1 != elfo3.getExperiencia());
        
        elfo2.atirarFlecha(dwarf);
        elfo2.atirarFlecha(dwarf);

        assertEquals(39, elfo2.getFlechas());
        assertFalse(39 != elfo2.getFlechas());
        assertEquals(3, elfo2.getExperiencia());
        ...
        assertFalse(flechas-3 != elfo.getFlechas());
        assertEquals(4, elfo.getExperiencia());
        assertFalse(4 != elfo.getExperiencia());
